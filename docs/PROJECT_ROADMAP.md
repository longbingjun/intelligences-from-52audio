...
在 GitHub 使用 **New Issue** 可选择对应模板（`.github/ISSUE_TEMPLATE/`）：

| 模板 | 说明 |
|------|------|
| V6: OCR BOM 闭环 | OCR merge 常态化，提升 BOM 覆盖率 |
| V6: 字段来源标注 | 对比表展示技术层/渠道层/OCR 来源 |
| V6: P0 完整度统计 | 按品类统计并展示 `data_completeness` |
| V6: 缺失值 UI 统一 | 空值文案与展示策略统一 |
| 迭代工作单 | 新迭代启动与 Gate 自检 |
